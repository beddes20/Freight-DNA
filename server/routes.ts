...
- Standard: $1,500/month (or $1,200/month billed annually — 20% savings). Full platform, up to 70 team members, all 20+ modules, all AI features, dedicated onboarding support. No per-seat fees.
- Enterprise: $2,000/month (or $1,600/month billed annually — 20% savings). For brokerages with 70+ team members. Everything in Standard plus unlimited seats, dedicated account manager, multi-org/multi-team support, and priority feature development. No per-seat fees.

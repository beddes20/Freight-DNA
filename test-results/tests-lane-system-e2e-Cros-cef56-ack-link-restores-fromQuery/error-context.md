...
- Name: tests/lane-system-e2e.spec.cjs >> Cross-tab breadcrumb contract >> lane-inbox → available-freight: breadcrumb renders + back-link restores fromQuery
...
Locator: locator('[data-testid="breadcrumb-cross-tab-available-freight"]')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="breadcrumb-cross-tab-available-freight"]')

  ...
  return (
    <div className="p-4 md:p-6 max-w-5xl mx-auto space-y-4 md:space-y-6">
      ...
      <div className="flex items-center gap-1 border-b pb-0 -mb-2">
        ...
        <a href="/carrier-lane-search" className="px-4 py-2 text-sm font-medium border-b-2 border-amber-500 text-amber-600 dark:text-amber-400 -mb-px" data-testid="tab-carrier-lane-search">Carrier Lane Search</a>
      </div>
      <div>

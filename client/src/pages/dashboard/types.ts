import type { User, FeedPost, PortletFreshness } from "@shared/schema";
...
export type TrendingResponse = { up: TrendingAccount[]; down: TrendingAccount[]; monthFraction?: number; isPartialMonth?: boolean; curMonthLabel?: string; asOfLabel?: string | null; freshness?: PortletFreshness | null };
...
export type MarginMetrics = { nams: MarginUserMetric[]; ams: MarginUserMetric[]; asOfLabel?: string | null; freshness?: PortletFreshness | null };

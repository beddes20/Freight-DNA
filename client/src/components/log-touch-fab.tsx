...
export function LogTouchFab() {
  ...
  return (
    <button
      ...
      className="fixed bottom-[5.5rem] right-6 z-50 flex items-center gap-2 px-4 py-3 rounded-full shadow-lg bg-primary text-primary-foreground hover:bg-primary/90 active:scale-95 transition-all duration-150 text-sm font-medium"
